"""UDP server on the Pico that receives brightness values (0–255) and controls an LED via PWM."""
...
# --- Wi-Fi Config ---
SSID = "WIFI-SSID"  # replace with your Wi-Fi SSID
PASSWORD = "WIFI-PASSWORD"  # replace with your Wi-Fi password
